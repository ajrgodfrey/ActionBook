...
```{r exampleHist, fig.height=7, fig.width=5, fig.cap="testing examples", echo=FALSE}
writeLines(GetExampleText(hist), "Temp.R")
...
```{r exampleScatterPlot, fig.height=8, fig.width=8, fig.cap="The six graphs generated by the `example(ScatterPlot)`", echo=FALSE}
writeLines(GetExampleText(ScatterPlot), "Temp.R")
source("Temp.R", echo=TRUE)
unlink("Temp.R")
```
...
```{r addGridLines, fig.dim=c(6,6), fig.cap="Scatter plot of Ozone versus Wind with grid lines added.", fig.keep="last"}
attach(airquality)
