...
$counts
 [1]   2   0   1  17  41  77 152 186 200 153  92  51  18   6   4

$density
 [1] 0.004 0.000 0.002 0.034 0.082 0.154 0.304 0.372 0.400 0.306 0.184
[12] 0.102 0.036 0.012 0.008
...
So let's see what `BrailleR` is going to offer a blind user instead of the verbose printout seen above. First, the `Describe()` function describes a histogram ina  general sense.
