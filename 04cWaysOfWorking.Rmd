...
cat(paste(readLines(system.file("Templates/YAMLHeader.Rmd", package="BrailleR")), collapse="\n"))
cat(paste(readLines(system.file("Templates/EmptyChunk.Rmd", package="BrailleR")), collapse="\n"))
```
